            ...
            <div class="content">
                ...
                <form class="login-form" method="post">
                    ...
                    <div class="form-group">
                        <!-- <div class="input-icon">
                            <input
                                class="form-control placeholder-no-fix  col-xs-6 col-sm-8 col-md-6"
                                type="text" style="width: 60%" autocomplete="off" value=""
                                placeholder="验证码" name="checkcode" id="checkcode" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img alt="验证码" height="32px"
                                id="captchaimg" onclick="this.src=this.src+'?'" />
                        </div> -->
                        <input type="hidden" id="smartip">
                    </div>
                    ...
                    <input name="randomString" id="randomString" type="hidden"
                           value="<%=(String) session.getAttribute("randomString")%>">
